...
public class CreateReportLogic {
	public Report execute(CheckAnsPage cap, Exam exam, Account user) {
		...
		Report newReport = new Report(reportID, userID, cap.getExamID(), new Date(), cap.getScore(), correctAnswerRate, exam.getExamName(), exam.getPassingScore());
